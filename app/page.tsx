...
export default function Home() {
  return (
    <section className="bg-white overflow-hidden">
      ...
      />
      <PublishYourBook title="Ready to Publish Your Book in Australia?" description="Join over 2,000 Australian authors who have trusted NexiFire Publishing to turn their manuscripts into professionally published books. Get a free consultation today." buttonLabel="Publish Your Book Today"/>
