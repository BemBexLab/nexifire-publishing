...
const beliefsEase = [0.22, 1, 0.36, 1] as const;
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1500px]">
        <motion.div className="text-center" variants={introVariants}>
          <motion.div
          ...
          <motion.h2
            className="project-h2 mt-6 leading-none"
            variants={itemVariants}
          >
            What We Believe
          </motion.h2>
        ...
        <motion.div
          className="relative mt-10 grid gap-y-10 sm:grid-cols-2 sm:gap-x-8 lg:grid-cols-4 lg:gap-x-0 lg:gap-y-0"
        ...
        >
          ...
          {beliefs.map((belief, index) => (
            <motion.article
              ...
              whileHover={{ y: -6 }}
              transition={{ duration: 0.28, ease: beliefsEase }}
            >
              <motion.div
              ...
              <motion.p
                className="mt-3 max-w-[350px] text-base leading-[1.55] text-[#7D7D7D] sm:text-lg"
                variants={itemVariants}
              >
                {belief.description}
              </motion.p>
