    ...
    <section className="overflow-hidden bg-white px-4 pt-16 sm:px-6 md:px-10 lg:px-16">
      <div className="mx-auto max-w-[1380px]">
        <div className="mx-auto mb-9 max-w-[720px] text-center">
          ...
          <p className="mx-auto mt-4 max-w-[640px] text-[14px] leading-6 text-[#989391] sm:text-[15px]">
          ...
          >
            {carouselItems.map((item, index) => (
              ...
              >
                ...
                <h3 className="mt-5 text-[22px] font-semibold leading-[1.12] tracking-[-0.035em] text-[#282828]">
                  {item.title}
                </h3>
                <p className="mt-2 text-[16px] leading-none tracking-[-0.02em] text-[#444444]">
                  {item.author}
                </p>

                <Link
                  href={item.amazonHref}
                  className="mt-6 inline-flex items-center justify-center rounded-[8px] bg-[linear-gradient(90deg,#B24002_0%,#FF5B01_100%)] px-4 py-[8px] text-[15px] font-light leading-none text-white shadow-[0_8px_18px_rgba(255,91,1,0.24)] transition hover:brightness-[1.03]"
                >
                  Buy on Amazon
