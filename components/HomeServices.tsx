          ...
          >
            {services.map((service) => (
              ...
              >
                ...
                />
                <h3 className="mt-3 min-h-[40px] text-base font-semibold leading-tight text-[#282828] sm:mt-6 sm:min-h-0 sm:text-lg">
                  {service.title}
                </h3>
                <p className="services-description-scroll mt-2 flex-1 text-sm leading-[1.55] text-[#444444]">
                  {service.description}
                </p>
              </motion.article>
            ))}
          ...
          <div className="mt-12 flex w-full flex-col items-center sm:mt-14 lg:mt-16">
            ...
            >
              ...
              <div className="relative z-10 flex min-h-[280px] w-full items-end px-5 py-6 sm:min-h-[320px] sm:px-8 sm:py-8 lg:min-h-[384px] lg:items-center lg:px-10">
                <div className="max-w-[400px] text-white sm:max-w-[760px]">
